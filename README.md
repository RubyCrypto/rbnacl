...
as bascule@gmail.com. You can obtain the official signature here:

https://raw.github.com/cryptosphere/rbnacl/master/bascule.cert

If you'd like to install the gem in high security mode, use:
